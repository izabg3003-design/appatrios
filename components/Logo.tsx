...
const Logo: React.FC<LogoProps> = ({ className = "w-10 h-10" }) => {
  return (
    ...
    >
      ...
      <circle cx="46" cy="42" r="28" fill="none" stroke="white" stroke-width="7"/>
      <path d="M46 22V42L62 52" stroke="white" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/>
